...
class Config:
    ...
    def __post_init__(self):
        ...
        self.center_freq        = (self.start_freq + self.sample_per_chirp/self.sampling_rate*pq.second*self.chirp_slope/2).rescale(pq.GHz)
...
def read_mmwave_json(path):
    ...
    kwargs["sampling_rate"]    = rl_profiles["digOutSampleRate"] * 1000 # Unit of sampling rate in json is ksps
