# -*- coding: utf-8 -*-
"""
Created on Wed May 22 17:21:52 2019
...
class OscilloscopeViewer(FigureWindow):
    window_name = 'WaveSyn-OscilloscopeViewer'
...
#)        
        ...
        tool_tabs.add(tab, text='Oscilloscope')
...
#            figure.plot(frequencies, current_data, *args, **kwargs)
            figure.plot(current_data, *args, **kwargs)
